...
def test_set_weights():
    ...
    # print(f'Current density: {curr_density}, Current spectral radius: {curr_spec_rad}')
    #print(f'Model reservoir layer density: {model.reservoir_layer.density}, Model spectral radius: {model.reservoir_layer.spec_rad}')
    # TODO issue #76 (update those properties after the weights are set)
